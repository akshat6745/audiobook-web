  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center py-16">
        <LoadingSpinner size="lg" message="Loading content..." variant="pulse" />
      </div>
    );
  }
    ...
    return (
      <div className="text-center py-16 px-4">
        <div className="glass-dark p-8 rounded-2xl border border-slate-700/50 max-w-md mx-auto">
          ...
          <p className="text-slate-300 text-lg font-medium">No content available</p>
          <p className="text-slate-400 text-sm mt-2">This chapter appears to be empty.</p>
        </div>
      </div>
    );
  }
      ...
      {chapterNumber && (
        <div className="text-center mb-6 animate-fade-in-down">
          <div className="inline-flex items-center px-4 py-2 glass-dark rounded-full border border-primary-500/30 mb-4">
            <svg className="w-4 h-4 text-primary-400 mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          {activeParagraphIndex !== null && (
            <>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-primary-300">Paragraph {activeParagraphIndex + 1}</span>
              </div>
            </>
          )}
