        ...
        return (
          <div className="relative">
            <div className={`${sizeClasses[size]} animate-spin`}>
              ...
              <div
                className="absolute inset-2 rounded-full border-2 border-transparent border-t-primary-300 border-r-accent-300 animate-spin"
                style={{
      ...
      {message && (
        <div className="text-center max-w-xs">
          ...
          <div className="mt-2 h-1 bg-slate-700 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-primary-500 to-accent-500 rounded-full animate-shimmer"
              style={{ width: "40%" }}
            />
          </div>
        </div>
