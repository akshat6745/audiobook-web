...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-accent-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 max-w-md w-full space-y-8 p-8">
        ...
        <div className="text-center animate-fade-in-down">
          ...
          <p className="text-lg text-slate-400">
            {isLogin ? 'Continue your reading journey' : 'Start your audiobook adventure'}
          </p>
        </div>
        
        {/* Form Container */}
        <div className="glass-dark rounded-2xl p-8 border border-slate-700/50 shadow-glow-lg animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Features */}
        <div className="grid grid-cols-2 gap-4 mt-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="glass-dark p-4 rounded-xl border border-slate-700/30 text-center">
            ...
            <p className="text-xs text-slate-300 font-medium">Secure & Private</p>
          </div>
        </div>
      </div>
    </div>
